...
!(function(t, e){
	...
	n = (function(){
		...
		(t.prototype.set = function(e, i, n){
			...
			t: for (var r in e) {
				...
				var p = s[r];
				this.isUndef(p) ||
					((t.Signal && p instanceof t.Signal) || (t.Param && p instanceof t.Param)
						? p.value !== i && (this.isUndef(n) ? (p.value = i) : p.rampTo(i, n))
						: p instanceof AudioParam
							? p.value !== i && (p.value = i)
							: p instanceof t ? p.set(i) : p !== i && (s[r] = i));
			}
			return this;
		}),
					...
					this.isObject(e[o])
						...
						: t.Signal && p instanceof t.Signal
							...
							: t.Param && p instanceof t.Param
								...
								: p instanceof AudioParam
									? (s[o] = p.value)
									: p instanceof t ? (s[o] = p.get()) : this.isFunction(p) || this.isUndef(p) || (s[o] = p);
				}
				return i;
			}),
	...
	r = (function(t){
		function e(){
			...
			AudioNode.prototype.connect !== e &&
				((AudioNode.prototype.connect = e), (AudioNode.prototype.disconnect = i));
		}
		return (
			!window.hasOwnProperty('AudioContext') &&
				window.hasOwnProperty('webkitAudioContext') &&
			...
			t.supported ? (e(), (t.context = new t.Context())) : console.warn('This browser does not support Tone.js'),
			t.Context
		);
	})(n);
	var s;
			...
			(t.prototype._mathChain = function(t, e, i, n, o){
				for (var r in t.mathOps)
					t.mathOps[r] instanceof o &&
						(t.mathOps[r].dispose(), (i = r), i < t.mathOps.length - 1 && (n = t.mathOps[r + 1]));
		...
		(t.SoundFile = function(e, i, n, o){
				...
				if (
					...
					o && (o = o <= this.buffer.duration - r ? o : this.buffer.duration),
						this._paused
							...
							: (this.bufferSourceNode.start(u, r, o), this._counterNode.start(u, r, o)),
						(this._playing = !0),
						(this._paused = !1),
			...
			(t.SoundFile.prototype.rate = function(t){
				...
				if (
					...
					0 === t
						? (t = 1e-13)
						: 0 > t && !this.reversed ? ((t = Math.abs(t)), (e = !0)) : t > 0 && this.reversed && (e = !0),
					this.bufferSourceNode)
				) {
					var i = l.audiocontext.currentTime;
			...
			(t.SoundFile.prototype.reverseBuffer = function(){
				...
				(this.reversed = !this.reversed), t && this.jump(this.duration() - t), this.setVolume(e, 0.001);
			}),
			...
			(t.SoundFile.prototype.connect = function(t){
				t
					? t.hasOwnProperty('input') ? this.panner.connect(t.input) : this.panner.connect(t)
	...
	l = (function(){
		...
		(t.Amplitude = function(t){
			...
			(t.Amplitude.prototype.connect = function(t){
				t
					? t.hasOwnProperty('input') ? this.output.connect(t.input) : this.output.connect(t)
			...
			(t.Amplitude.prototype._audioProcess = function(t){
				...
				var p = this,
					h = this.stereoVol.reduce(function(t, e, i){
						return (
							(p.stereoVolNorm[i - 1] = Math.max(Math.min(p.stereoVol[i - 1] / p.volMax, 1), 0)),
			...
			(t.Amplitude.prototype.getLevel = function(t){
				return 'undefined' != typeof t
					? this.normalize ? this.stereoVolNorm[t] : this.stereoVol[t]
					: this.normalize ? this.volNorm : this.volume;
			}),
		...
		(t.FFT = function(t, i){
			...
			(t.FFT.prototype.waveform = function(){
				...
				if (i && !t.prototype._isSafari())
					return (
						o(this, this.timeDomain), this.analyser.getFloatTimeDomainData(this.timeDomain), this.timeDomain
					);
	...
	y = (function(t){
		return (
			...
			(t.TimeBase.prototype._tokenize = function(t){
				function e(t, e){
					for (
						var i = [ '_binaryExpressions', '_unaryExpressions', '_primaryExpressions', '_syntaxGlue' ],
							n = 0;
						n < i.length;
						n++
					) {
		...
		return (
			...
			(t.prototype.toSeconds = function(e){
				return this.isNumber(e)
					...
					: this.isUndef(e)
						? this.now()
						: this.isString(e) ? new t.Time(e).toSeconds() : e instanceof t.TimeBase ? e.toSeconds() : void 0;
			}),
			(t.prototype.toFrequency = function(e){
				return this.isNumber(e)
					...
					: this.isString(e) || this.isUndef(e)
						...
						: e instanceof t.TimeBase ? e.toFrequency() : void 0;
			}),
			(t.prototype.toTicks = function(e){
				return this.isNumber(e) || this.isString(e)
					? new t.TransportTime(e).toTicks()
					: this.isUndef(e) ? t.Transport.ticks : e instanceof t.TimeBase ? e.toTicks() : void 0;
			}),
			t
		);
	})(n, v, g, _);
		...
		return (
			...
			(t.Param.prototype.rampTo = function(e, i, n){
				return (
					...
					this.units === t.Type.Frequency || this.units === t.Type.BPM || this.units === t.Type.Decibels
	...
	k = (function(){
		...
		(t.Signal = function(t){
			...
			(e.prototype.scale = function(e, i, n, r){
				var s, a;
				4 === arguments.length
					? ((s = t.prototype.map(n, e, i, 0, 1) - 0.5), (a = t.prototype.map(r, e, i, 0, 1) - 0.5))
	...
	O = (function(){
			...
			(t.Oscillator.prototype.freq = function(t, i, n){
				if ('number' != typeof t || isNaN(t)) {
					...
					0 === i
						...
						: t > 0
							? this.oscillator.frequency.exponentialRampToValueAtTime(t, n + i + o)
		...
		(t.Oscillator.prototype.add = function(t){
			...
			(t.Oscillator.prototype.scale = function(e, i, n, s){
				var a, u;
				4 === arguments.length
					? ((a = t.prototype.map(n, e, i, 0, 1) - 0.5), (u = t.prototype.map(s, e, i, 0, 1) - 0.5))
		...
		return (
			...
			(t.TimelineSignal.prototype.setValueAtTime = function(e, i){
				return (
					(e = this._fromUnits(e)),
					(i = this.toSeconds(i)),
					this._events.add({ type: t.TimelineSignal.Type.Set, value: e, time: i }),
			...
			(t.TimelineSignal.prototype.linearRampToValueAtTime = function(e, i){
				return (
					(e = this._fromUnits(e)),
					(i = this.toSeconds(i)),
					this._events.add({ type: t.TimelineSignal.Type.Linear, value: e, time: i }),
			...
			(t.TimelineSignal.prototype.exponentialRampToValueAtTime = function(e, i){
				...
				return (
					this._events.add({ type: t.TimelineSignal.Type.Exponential, value: o, time: i }),
					e < this._minOutput
						? (this._param.exponentialRampToValueAtTime(this._minOutput, i - this.sampleTime),
			...
			(t.TimelineSignal.prototype.setValueCurveAtTime = function(e, i, n, o){
				...
				(i = this.toSeconds(i)),
					(n = this.toSeconds(n)),
					this._events.add({ type: t.TimelineSignal.Type.Curve, value: r, time: i, duration: n }),
				...
				if (n && n.time === e) this.cancelScheduledValues(e + this.sampleTime);
					...
					o &&
						...
						o.type === t.TimelineSignal.Type.Linear
							...
							: o.type === t.TimelineSignal.Type.Exponential && this.exponentialRampToValueAtTime(i, e)),
		...
		(t.Envelope = function(t, i, n, o, s, a){
			...
			(t.Envelope.prototype._init = function(){
				var t = e.audiocontext.currentTime,
					i = t;
				this.control.setTargetAtTime(1e-5, i, 0.001), this._setRampAD(this.aTime, this.dTime);
			}),
			...
			(t.Envelope.prototype.triggerAttack = function(t, i){
				...
				this.isExponential === !0
					...
					(r += this.aTime),
					this.isExponential === !0
						? (this.control.exponentialRampToValueAtTime(this.checkExpInput(this.aLevel), r),
					...
					(r += this.dTime),
					this.isExponential === !0
						? (this.control.exponentialRampToValueAtTime(this.checkExpInput(this.dLevel), r),
							(s = this.checkExpInput(this.control.getValueAtTime(r))),
							this.control.cancelScheduledValues(r),
							this.control.exponentialRampToValueAtTime(s, r))
			...
			(t.Envelope.prototype.triggerRelease = function(t, i){
				if (this.wasTriggered) {
					...
					this.isExponential === !0
						...
						(r += this.rTime),
						this.isExponential === !0
							? (this.control.exponentialRampToValueAtTime(this.checkExpInput(this.rLevel), r),
								(s = this.checkExpInput(this.control.getValueAtTime(r))),
								this.control.cancelScheduledValues(r),
								this.control.exponentialRampToValueAtTime(s, r))
			...
			(t.Envelope.prototype.ramp = function(t, i, n, o){
				...
				u > p
					? (this.control.setTargetAtTime(u, a, this._rampAttackTC), (a += this._rampAttackTime))
					: p > u && (this.control.setTargetAtTime(u, a, this._rampDecayTC), (a += this._rampDecayTime)),
					void 0 !== c &&
						(c > u
	...
	E = (function(){
		function e(){
			for (
				var t = i.audiocontext, e = t.createBuffer(1, 2048, t.sampleRate), n = e.getChannelData(0), o = 0;
				2048 > o;
				o++
			)
				n[o] = 1;
		...
		(e.inputSources = []),
			(t.AudioIn = function(i){
				(this.input = e.audiocontext.createGain()),
					...
					(window.MediaStreamTrack &&
						...
						(i ? i() : window.alert('This browser does not support MediaStreamTrack and mediaDevices')),
					e.soundArray.push(this);
			}),
			...
			(t.AudioIn.prototype.connect = function(t){
				t
					? t.hasOwnProperty('input')
						...
						: t.hasOwnProperty('analyser') ? this.output.connect(t.analyser) : this.output.connect(t)
			...
			(t.AudioIn.prototype.setSource = function(t){
				e.inputSources.length > 0 && t < e.inputSources.length
					? ((this.currentSource = t), console.log('set source to ', e.inputSources[this.currentSource]))
			...
			(t.Expr.prototype._parseTree = function(e){
				...
				function o(t){
					...
					for (var i = c.peek(); n(i, 'binary', t); )
						(i = c.next()),
							(e = { operator: i.value, method: i.method, args: [ e, o(t - 1) ] }),
							(i = c.peek());
					return e;
				}
				function r(){
					...
					return (
						(t = c.peek()),
						n(t, 'unary')
							? ((t = c.next()), (e = r()), { operator: t.value, method: t.method, args: [ e ] })
							: s()
					);
				}
				function s(){
		...
		return (
			...
			(t.Filter.prototype.freq = function(t, e){
				...
				return (
					0 >= t && (t = 1),
					'number' == typeof t
						? (this.biquad.frequency.cancelScheduledValues(this.ac.currentTime + 0.01 + i),
							this.biquad.frequency.exponentialRampToValueAtTime(t, this.ac.currentTime + 0.02 + i))
				...
				return (
					'number' == typeof t
						? ((this.biquad.Q.value = t),
							this.biquad.Q.cancelScheduledValues(this.ac.currentTime + 0.01 + i),
							this.biquad.Q.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + i))
				...
				return (
					'number' == typeof t
						? ((this.biquad.gain.value = t),
							this.biquad.gain.cancelScheduledValues(this.ac.currentTime + 0.01 + i),
							this.biquad.gain.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + i))
				...
				return (
					'number' == typeof t
						? ((this.panner.positionX.value = t),
							this.panner.positionX.cancelScheduledValues(this.ac.currentTime + 0.01 + i),
							this.panner.positionX.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + i))
				...
				return (
					'number' == typeof t
						? ((this.panner.positionY.value = t),
							this.panner.positionY.cancelScheduledValues(this.ac.currentTime + 0.01 + i),
							this.panner.positionY.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + i))
				...
				return (
					'number' == typeof t
						? ((this.panner.positionZ.value = t),
							this.panner.positionZ.cancelScheduledValues(this.ac.currentTime + 0.01 + i),
							this.panner.positionZ.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + i))
				...
				return (
					'number' == typeof t
						? ((this.panner.orientationX.value = t),
							this.panner.orientationX.cancelScheduledValues(this.ac.currentTime + 0.01 + i),
							this.panner.orientationX.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + i))
				...
				return (
					'number' == typeof t
						? ((this.panner.orientationY.value = t),
							this.panner.orientationY.cancelScheduledValues(this.ac.currentTime + 0.01 + i),
							this.panner.orientationY.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + i))
				...
				return (
					'number' == typeof t
						? ((this.panner.orientationZ.value = t),
							this.panner.orientationZ.cancelScheduledValues(this.ac.currentTime + 0.01 + i),
							this.panner.orientationZ.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + i))
				...
				return (
					'number' == typeof t
						? ((this.listener.positionX.value = t),
							this.listener.positionX.cancelScheduledValues(this.ac.currentTime + 0.01 + i),
							this.listener.positionX.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + i))
				...
				return (
					'number' == typeof t
						? ((this.listener.positionY.value = t),
							this.listener.positionY.cancelScheduledValues(this.ac.currentTime + 0.01 + i),
							this.listener.positionY.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + i))
				...
				return (
					'number' == typeof t
						? ((this.listener.positionZ.value = t),
							this.listener.positionZ.cancelScheduledValues(this.ac.currentTime + 0.01 + i),
							this.listener.positionZ.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + i))
				...
				return (
					'number' == typeof t
						? ((this.listener.forwardX.value = t),
							this.listener.forwardX.cancelScheduledValues(this.ac.currentTime + 0.01 + i),
							this.listener.forwardX.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + i))
				...
				return (
					'number' == typeof t
						? ((this.listener.forwardY.value = t),
							this.listener.forwardY.cancelScheduledValues(this.ac.currentTime + 0.01 + i),
							this.listener.forwardY.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + i))
				...
				return (
					'number' == typeof t
						? ((this.listener.forwardZ.value = t),
							this.listener.forwardZ.cancelScheduledValues(this.ac.currentTime + 0.01 + i),
							this.listener.forwardZ.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + i))
				...
				return (
					'number' == typeof t
						? ((this.listener.upX.value = t),
							this.listener.upX.cancelScheduledValues(this.ac.currentTime + 0.01 + i),
							this.listener.upX.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + i))
				...
				return (
					'number' == typeof t
						? ((this.listener.upY.value = t),
							this.listener.upY.cancelScheduledValues(this.ac.currentTime + 0.01 + i),
							this.listener.upY.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + i))
				...
				return (
					'number' == typeof t
						? ((this.listener.upZ.value = t),
							this.listener.upZ.cancelScheduledValues(this.ac.currentTime + 0.01 + i),
							this.listener.upZ.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + i))
			...
			(t.Convolver = function(e, i, n){
				t.Reverb.call(this),
					...
					e
						...
						: ((this._seconds = 3), (this._decay = 2), (this._reverse = !1), this._buildImpulse());
			}),
	...
	et = (function(t){
		...
		return (
			...
			(t.Clock.prototype.stop = function(e){
				return (
					(e = this.toSeconds(e)), this._state.cancel(e), this._state.setStateAtTime(t.State.Stopped, e), this
				);
			}),
		...
		(t.prototype.setBPM = function(t, e){
			...
			(t.Part.prototype.incrementStep = function(t){
				this.partStep < this.length - 1
					...
					: this.looping || this.partStep !== this.length - 1 || (console.log('done'), this.onended());
			}),
				...
				return (
					'number' == typeof t
						? ((this.compressor.attack.value = t),
							this.compressor.attack.cancelScheduledValues(this.ac.currentTime + 0.01 + i),
							this.compressor.attack.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + i))
				...
				return (
					'number' == typeof t
						? ((this.compressor.knee.value = t),
							this.compressor.knee.cancelScheduledValues(this.ac.currentTime + 0.01 + i),
							this.compressor.knee.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + i))
				...
				return (
					'number' == typeof t
						? ((this.compressor.ratio.value = t),
							this.compressor.ratio.cancelScheduledValues(this.ac.currentTime + 0.01 + i),
							this.compressor.ratio.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + i))
				...
				return (
					'number' == typeof t
						? ((this.compressor.threshold.value = t),
							this.compressor.threshold.cancelScheduledValues(this.ac.currentTime + 0.01 + i),
							this.compressor.threshold.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + i))
				...
				return (
					'number' == typeof t
						? ((this.compressor.release.value = t),
							this.compressor.release.cancelScheduledValues(this.ac.currentTime + 0.01 + i),
							this.compressor.release.linearRampToValueAtTime(t, this.ac.currentTime + 0.02 + i))
		...
		(t.PolySynth = function(n, o){
			...
			(t.PolySynth.prototype.noteAttack = function(o, r, s){
				var a,
					...
					p = r || 0.1;
				if (
					(this.notes[c] && null !== this.notes[c].getValueAtTime(u) && this.noteRelease(c, 0),
	...
	lt = (function(){
		function e(t){
			for (
				var e, i = 'number' == typeof t ? t : 50, n = 44100, o = new Float32Array(n), r = Math.PI / 180, s = 0;
				n > s;
				++s
			)
		...
		(t.Distortion = function(n, o){
			if ((i.call(this), 'undefined' == typeof n && (n = 0.25), 'number' != typeof n))
